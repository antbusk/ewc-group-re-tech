...
new_product();
    ...
    $('form').submit(function(event) {
		...
		var prod_unid = document.getElementById("prod_unid").value;
        $.ajax({
...
<li class="active"><a href="photos_seconed_screen.php" target="_blank">Seconded Screen</a></li>
</ul>
<hr />
</div>
</div>
<div class="row" >
	...
	<p><button class="btn btn-large" type="submit" onClick="take_snapshot()" name="submit" >Take Photo</button></p>

	<p><button class="btn btn-large" type="submit" onClick="send_info()" name="submit" >Photo Is Good</button></p>
	...
	<script type="text/javascript" src="webcam_pic/static/webcam.js"></script>
...
<div class="col-sm-6">
			<p>Scan Sku</p>
		<hr />
		<form id="form_sku" action="upload_url.php" method="post">
<table width="100%" border="0">

    <tr style="height: 35px;">
    <td>Product Id:</td>
    <td><?php echo generateTextAuto('prod_unid', '', 'false');  ?><td>
  </tr>
  <tr style="height: 35px;">
