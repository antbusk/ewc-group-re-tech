...
$object_image_url = CloudStorageTools::getImageServingUrl($object_image_file,
		...
		$requestXmlBody .= "<StartPrice>160.00</StartPrice>";
...
<div class="col-sm-6">
			<p>Scan Sku</p>
		<hr />
		<form id="form_sku" action="ebay_game_list.php" method="post">
