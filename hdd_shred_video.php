...
$user_id = $_GET['user'];
$url = $_GET['url'];
$query = "INSERT INTO videos (prod_unid, hdd_shred) VALUES ('$prod_unid', 1)";
...
file_put_contents('gs://ewc-group-re-tech.appspot.com/videos/' . $vid_name . '.mp4', fopen($url, 'r'), 0, $options);
