...
<html>
	<head>
		...
		<script language="JavaScript" src="static/scriptcam.js"></script>
		...
		<style>
			...
			#volumeMeter {
				background-image:url('static/ledsbg.png');
				width:19px;
				height:133px;
				padding-top:5px;
			}
			...
			.ui-slider {
				background:none;
				background-image:url('static/trackslider.png');
				border:0;
				height:107px;
				margin-top:16px;
			}
			.ui-slider .ui-slider-handle {
				...
				margin-left:7px;
				margin-bottom:-16px;
				background:url(static/volumeslider.png) no-repeat; 
			}
			#volumePanel {
		...
		<div id="recorder">
			...
			<div id="volumePanel" style="float:left;position:relative;top:10px;">
				<div id="volumeMeter" style="position:absolute;top:10px;left:7px;float:left;">
					<img id="LedBar32" src="static/ledred.png">
					<img id="LedBar31" src="static/ledred.png">
					<img id="LedBar30" src="static/ledred.png">
					<img id="LedBar29" src="static/ledred.png">
					<img id="LedBar28" src="static/ledred.png">
					<img id="LedBar27" src="static/ledred.png">
					<img id="LedBar26" src="static/ledred.png">
					<img id="LedBar25" src="static/ledred.png">
					<img id="LedBar24" src="static/ledred.png">
					<img id="LedBar23" src="static/ledred.png">
					<img id="LedBar22" src="static/ledred.png">
					<img id="LedBar21" src="static/ledred.png">
					<img id="LedBar20" src="static/ledgreen.png">
					<img id="LedBar19" src="static/ledgreen.png">
					<img id="LedBar18" src="static/ledgreen.png">
					<img id="LedBar17" src="static/ledgreen.png">
					<img id="LedBar16" src="static/ledgreen.png">
					<img id="LedBar15" src="static/ledgreen.png">
					<img id="LedBar14" src="static/ledgreen.png">
					<img id="LedBar13" src="static/ledgreen.png">
					<img id="LedBar12" src="static/ledgreen.png">
					<img id="LedBar11" src="static/ledgreen.png">
					<img id="LedBar10" src="static/ledgreen.png">
					<img id="LedBar9" src="static/ledgreen.png">
					<img id="LedBar8" src="static/ledgreen.png">
					<img id="LedBar7" src="static/ledgreen.png">
					<img id="LedBar6" src="static/ledgreen.png">
					<img id="LedBar5" src="static/ledgreen.png">
					<img id="LedBar4" src="static/ledgreen.png">
					<img id="LedBar3" src="static/ledgreen.png">
					<img id="LedBar2" src="static/ledgreen.png">
					<img id="LedBar1" src="static/ledgreen.png">
				</div>
			...
			<br clear="both"/>
			<div id="setupPanel">
				<img src="static/webcamlogo.png" style="vertical-align:text-top"/>
