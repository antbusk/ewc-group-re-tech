...
window.webcam = {
	...
	swf_url: 'static/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'static/shutter.mp3', // URI to shutter.mp3 sound
	...
	set_shutter_url: function(url) {
		// set location of SWF movie (defaults to webcam.swf in cwd)
		this.shutter_url = url;
	},
